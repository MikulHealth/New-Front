...
const ReportSubmissionDocumentationModal = ({ isOpen, onClose }) => {
  return (
    <Modal
      theme={customTheme}
    ...
    >
      <ModalOverlay />
      <ModalContent>
        <ModalHeader textAlign="center" color="#A210C6" fontFamily="heading">How to Submit Patient Report</ModalHeader>
        <ModalBody>
          <VStack fontFamily="body" align="start" spacing={4}>
            ...
            <UnorderedList spacing={3}>
              <ListItem>
                ...
                <Text>
                  Choose the patient for whom you are submitting the report from
                  the dropdown menu.
                </Text>
              </ListItem>
              <ListItem>
                ...
                <Text>
                  ...
                  pressure, pulse, blood sugar, SpO2, and respiration. If a
                  vital sign is not available, enter "nil".
                </Text>
              </ListItem>
              <ListItem>
...
export default ReportSubmissionDocumentationModal;
